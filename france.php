...
<div class="block_principale block_france cadre_scroll">
    ...
    <div id="inscrit_t1" class="nb_inscrit_fr titre_tours">
    ...
    <div id="age_france">
        <div id="graph_age_france">
            ...
            <div class="item_age_legende">
                <div class="leg_1">
                    <div class="couleur_leg_1"></div>Vote aux 2 tours
                </div>
                <div class="leg_2">
                    <div class="couleur_leg_2"></div>Tour 1 seulement
                </div>
                <div class="leg_3">
                    <div class="couleur_leg_3"></div>Tour 2 seulement
                </div>
                <div class="leg_4">
                    <div class="couleur_leg_4"></div>Pas voté
                </div>
            </div>
